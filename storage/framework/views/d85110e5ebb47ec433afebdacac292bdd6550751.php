<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret  bg-gradient-dark" id="sidenav-main">
    ...
    <?php echo $__env->make('dashboard.layouts.particials.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\Users\kosar ahmadian\payStar\resources\views/dashboard/layouts/particials/left-sidebar.blade.php ENDPATH**/ ?>